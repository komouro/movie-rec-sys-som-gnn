...
The first model employs cosine similarity to measure the similarity score between plot summaries. The following plot depicts the similarity score of the top recommendation against the number of maximum features for the TF-IDF method.
